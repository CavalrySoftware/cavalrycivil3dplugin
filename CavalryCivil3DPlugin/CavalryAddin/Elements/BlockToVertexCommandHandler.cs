...
using CavalryCivil3DPlugin.CavalryPlugins._CustomCommands;
using CavalryCivil3DPlugin.CavalryPlugins.LowerPipe;

namespace CavalryCivil3DPlugin.CavalryAddin.PressurePipes
{
    public class BlockToVertexCommandHandler : System.Windows.Input.ICommand
    {
        ...
        public void Execute(object parameter)
        {
            ...
            {
                InsertBlockToVertex.BlockToVertex();
            }
        }
    }
}