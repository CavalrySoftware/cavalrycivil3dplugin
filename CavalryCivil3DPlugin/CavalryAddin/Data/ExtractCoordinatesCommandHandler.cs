...
using CavalryCivil3DPlugin.CavalryPlugins.ExtractCoordinates;
using CavalryCivil3DPlugin.CavalryPlugins.LowerPipe;

namespace CavalryCivil3DPlugin.CavalryAddin.Data
{

    public class ExtractCoordinatesCommandHandler : System.Windows.Input.ICommand
    {
        ...
        public void Execute(object parameter)
        {
            ...
            {
                ExtractCoordinatesStartUp.ExtractCoordinates();
            }
        }
    }
}
